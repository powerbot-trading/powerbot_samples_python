...
***
####Content:
1. [Simple Example of a REST call](#simple-example-of-a-rest-call)
2. [Simple Example of a websocket](#simple-example-of-a-websocket)
3. [Simple Example of an Algorithm](#simple-example-of-an-algorithm)
4. [Advanced Example of an Algorithm](#advanced-example-of-an-algorithm)
***
